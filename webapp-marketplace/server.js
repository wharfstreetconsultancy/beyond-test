...
//						'Authorization': authToken
					...
					request.post({url: 'https://api.sandbox.paypal.com/v1/oauth2/token', headers: JSON.stringify(headers), body: JSON.stringify(body)}, function (accessError, accessResponse, accessBody) {
